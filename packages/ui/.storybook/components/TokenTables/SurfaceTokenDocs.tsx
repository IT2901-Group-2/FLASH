...
const CONCEPT_GROUPS: ConceptGroup[] = [
  ...
  },
  {
    concept: "accent",
    description:
      "Warm sand/terracotta accent for highlights, badges, and decorative elements.",
    tokens: [
      {
  ...
  },
  {
    concept: "text",
    description:
      "Foreground text. base/dark/light for hierarchy; secondary and tertiary for muted labels.",
    tokens: [
      {
  ...
  },
  {
    concept: "border",
    description:
      "Dividers and outlines that separate surfaces and define component boundaries.",
    tokens: [
      {
  ...
  },
  {
    concept: "destructive",
    description:
      "Error states, delete actions, and other irreversible or dangerous interactions.",
    tokens: [
      {
        cssVar: "--color-destructive-base",
        variant: "base",
        lightHex: "#e22948",
        darkHex: "#e22948",
      },
      {
        cssVar: "--color-destructive-dark",
        variant: "dark",
        lightHex: "#c0233d",
        darkHex: "#c0233d",
      },
      {
        cssVar: "--color-destructive-light",
        variant: "light",
        lightHex: "#e64963",
        darkHex: "#e64963",
      },
